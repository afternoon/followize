...
fw.view = {
    ...
    EMPTY_STATUS_HTML: '<td class="status"><span class="nevertweeted">{{screen_name}} hasn\'t tweeted anything yet.</span></td><td class="send_reply">&nbsp;</td><td class="send_retweet"></td>&nbsp;<td class="send_dm">&nbsp;</td>',
    ...
    appendUser: function(user, container) {
        ...
        if (user["status"].id === null) {
            templates["status"] = fw.view.EMPTY_STATUS_HTML;
        };
